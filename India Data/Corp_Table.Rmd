...
changefreq <- (summed_freqs$Freq - summed_freqs3$Freq)**2
...
changedf$avg_age <- (summed_freqs$avg_age - summed_freqs3$avg_age)**2

changedf$h_size <- (summed_freqs$avg_hsize - summed_freqs3$avg_hsize)**2
...
changedf$wage <- (summed_freqs$avg_wages - summed_freqs3$avg_wages)**2

changedf$hours <- (summed_freqs$avg_hours - summed_freqs3$avg_hours)**2
...
change <- (summed_freqs$Freq - summed_freqs4$Freq)**2
...
changes$avg_age <- (summed_freqs$avg_age - summed_freqs4$avg_age)**2

changes$h_size <- (summed_freqs$avg_hsize - summed_freqs4$avg_hsize)**2
...
changes$wage <- (summed_freqs$avg_wages - summed_freqs4$avg_wages)**2

changes$hours <- (summed_freqs$avg_hours - summed_freqs4$avg_hours)**2
...
for (col in names(changedf)) {
  comparison_df[[col]] <- ifelse(changedf[[col]] < changes[[col]], "changedf",
                                 ifelse(changedf[[col]] > changes[[col]], "changes", "tie"))
}
